...
import {FIREBASE_CONFIG} from '../config/firebase-config.js?v=20';
...
if(configValid){
  try{
    ...
    // Explicit Auth initialization makes popup/redirect sign-in more reliable
    // across mobile browsers while retaining local/session persistence support.
